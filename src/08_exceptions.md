...
3. *Basic* — в случае исключения объект останется в корректном состоянии (т.е. все инварианты останутся верными и не произойдёт утечка ресурсов), но ничего более корректного состояния не гарантируется.
