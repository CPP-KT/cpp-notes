...
- **Ограниченная память**\
	...
	А ещё, информация про то, как раскручивать стэк, которая хранится в файле, лежит не в том виде, которым удобно пользоваться, а в том, который занимает мало места.
