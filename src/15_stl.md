...
Как уже было сказано выше, **input** и **output** итераторы позволяют пройти по диапазону только один раз. При этом **input** итераторы позволяют читать данные, а **output** итераторы~--- записывать.
